...
* **Phím tắt:** Được map 1:1 từ sxhkd sang config hyprland cục bộ.
...
Để khởi động Hyprland, thường chỉ cần chạy `start-hyprland` từ TTY hoặc chọn nó trong trình quản lý hiển thị của bạn.
